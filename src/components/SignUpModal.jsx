...
function SignUpModal({ onClose, openLogin, handleContainer }) {
  //Hooks
        ...
        <div className="bg-tiffany-blue p-8 rounded-xl shadow-md w-80 md:w-auto px-10 relative">
          ...
          <div className="py-2 w-full">
            ...
            <div className="mt-2 mb-1">
              <span className="font-poppins text-xs md:text-sm text-base-2">
                Already have an account?
              </span>
            </div>

            <OutlineBtn label="Login" onClick={handleLoginButton} />
