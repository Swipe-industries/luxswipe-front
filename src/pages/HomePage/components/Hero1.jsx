    ...
    <>
        ...
        <div className="max-w-7xl mt-8 mx-auto flex flex-col md:flex-row items-center justify-between">
          <div className="mb-8 md:-mt-[80px] md:mb-0 md:mr-0">
            ...
            <p className="text-[13px] text-contrast-3 font-poppins mb-4">
            Stop creating web of stores and product links
            </p>
            <h3 className="text-2xl md:text-2xl lg:text-3xl font-kalnia-300 text-contrast-3 mb-0">
            Create a digital shop
            </h3>
            <p className="text-[14px] text-contrast-3 font-poppins mb-4">
          ...
          <div className="md:ml-8 bg-transparent z-8 flex  items-center justify-center w-[490px] mt-5 md:mt-16  h-[430px] md:h-[504px] relative">
              <img className=" cursor-pointer w-[400px]  md:w-[450px] md:left-12 duration-200 absolute top-[70px] " src={bottom} alt="" />  
              <img className=" w-[440px] md:w-[545px] md:left-7 absolute  top-[30px] " src={middle} alt="" />  
            <img className=" w-[440px] md:w-[545px] md:left-7 absolute md:hover:-top-14 md:hover:-left-14 duration-300 top-[0px] " src={top} alt="" />  
          </div>
        </div>
      </div >

      <div className="flex items-center justify-center pb-[100px] pt-[50px]" >
       <p className="text-white font-poppins text-[28px]" >Grab One for Yourself</p>
      </div>

     
      <div className=" mx-auto mb-20 text-white flex items-center justify-center text-[27px]  overflow-hidden font-poppins rounded-lg w-[300px] h-[169px] md:w-[510px] md:h-[260px]  bg-[#D64F87] " >
          <div>
      ...
      <h1 className="text-center text-2xl overflow-hidden relative md:-mt-20 font-bold text-[#D64F87]  ">anasssss</h1>
      <div className="w-[250px] z-10 text-[#D64F87] -mt-[7px] overflow-hidden h-8 text-transparent absolute bg-[#000000 ]" >
.
      </div>
      <div className="w-[220px] z-10 text-[#D64F87] mt-[144px] -ml-[5px] md:mt-[230px] overflow-hidden h-4 absolute bg-[#D64F87]" >
.
      </div>
