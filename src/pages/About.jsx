        ...
        >
          ...
          <div className="flex md:flex-col flex-row justify-center gap-52 md:gap-8 md:mb-8">
            <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-20">
              ...
              >
                <p className="mb-3">
                  I'm a dedicated developer and UI/UX designer with a keen eye
                  for creating intuitive and engaging digital experiences.
                  Currently, I'm spearheading the development of LuxSwipe, an
                  innovative platform designed to seamlessly integrate
                  e-commerce functionalities for social media influencers.
                  Beyond coding, I have a deep passion for photography and
                  cinematography, constantly seeking new ways to capture and
